                            ...
                            <div class="card-header py-3">
                                <div class="row">
                                    ...
                                    <div clas="col" align="right">
                                        ...
                                        <button type="submit" name="edit_button" id="edit_button" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Save</button>
                                        &nbsp;&nbsp;
                                    </div>
                                </div>
                            </div>
                                ...
                                <!--<div class="row">
                                    <div class="col-md-6">!-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                            <input id="admin_password" type="password" class="form-control" name="admin_password" value="secret" required  data-parsley-trigger="keyup" data-parsley-maxlength="16"/>
                                            <span toggle="#admin_password" class="fa fa-fw fa-eye field-icon toggle-admin_password"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script>
$(".toggle-admin_password").click(function() {
