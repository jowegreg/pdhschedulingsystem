...
<head>
    ...
    .h3 {text-align: center; color: white; font-size: 40px; text-shadow: 0 0 4px black, 0 0 6px darkgreen;}
    </style>

</head>

<body class="text-center" style="background-image: url(../img/pdhback.jpg); background-attachment: fixed; max-height: 100vh;
    height: 100vh; background-repeat: no-repeat; background-attachment: fixed; background-size: cover; height: 100%;">
    <main class="form-signin">
         <form method="post" id="login_form">
            <h1 class="h3 mb-3 fw-normal">PDH ADMIN</h1>
            <span id="error"></span>
