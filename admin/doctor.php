		          	...
		          	<div class="form-group">
                        <div class="row">
							...
							<label>Doctor Password <span class="text-danger">*</span></label>
                                    <div>
                                    <input id="doctor_password" type="password" class="form-control" name="doctor_password" value="secret" required data-parsley-trigger="keyup"/>
                                    <span toggle="#doctor_password" class="fa fa-fw fa-eye field-icon toggle-doctor_password"></span>
                                    </div>
                                </div>
		          		</div>
		          	</div>
...
<script>
$(".toggle-doctor_password").click(function() {
